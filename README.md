...
- `/dashboard/upload` — загрузка Excel-файла прямо из браузера (только админ).
  Дубликаты gtk-строк отсекаются автоматически по SHA-256-хешу содержимого,
